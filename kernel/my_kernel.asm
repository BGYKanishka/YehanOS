...
start:
    ...
    mov si, welcome_msg         ; Load the address of the "Welcome YehanOS Yehan>>" message into SI
...
booting_floppy_msg  db "Booting from Floppy...", 0 ; Moved from bootloader
loading_boot_image_msg db "Loading Boot Image", 0 ; Moved from bootloader

welcome_msg     db "Welcome YehanOS Yehan>> ", 0 ; New welcome message for your OS
prompt          db "> ", 0                  ; Command prompt
info_cmd        db "info", 0                ; The command string
unknown         db " Unknown command!", 0    ; Message for unrecognized commands

; Input Buffer
input_buffer    times 32 db 0               ; Buffer to store user input
